        ...
        <div className="vh-100 d-flex align-content-center justify-content-center bg-beige">
            <div className="forgot-password-container mx-4">
                <div className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p className="text-center poppins-font">Para garantizar tu identidad, te hemos enviado un correo eléctronico
                       con el que podrás confirmar tu cuenta. No te detengas, estas a un solo click de hacer nuevos amigos.</p>
                </div>
            </div>
        </div>
    );
