  ...
  return (
        <>
          <div className="d-flex flex-column justify-content-center align-items-center">
            ...
            <p className="text-center poppins-font">Pon tu número de carné que usaste para registrarte.
              Te enviaremos un correo con un enlace para restablecer tu contraseña.</p>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="d-flex justify-content-end mt-4">
              ...
              <button onSubmit={onSubmit} className="ms-1 btn-fill">ENVIAR</button>
            </div>
          </form>
        </>
    );
